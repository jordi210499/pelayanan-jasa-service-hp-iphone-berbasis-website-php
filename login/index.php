...
<div class="login-box">
  ...
  <div class="login-box-body">
    <div align="center"><a><img src="../gambar/3.jpeg" style="width: 15vw; height: 11vw;" /></a></div>
    ...
    <form action="" method="post">
      ...
      <hr>
        <p>Distributed by <a href="https://g.page/ikids_service?gm" target="_blank" rel="noopener noreferrer">https://g.page/ikids_service?gm</a></p>
    </form>
    <?php 
    if(@$_POST['login']){
