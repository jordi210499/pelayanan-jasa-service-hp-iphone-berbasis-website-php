            ...
            <div>
              ...
              ?>
                  <div class="item active">
                    <img class="carousel-image" src="gambar/halaman_utama/1.jpeg" alt="first slide" style="width: 100%; height: 50vw;">
                  </div>
              <?php
                while($data = $tampil->fetch_object()){
               ?>
                  <div class="item">
                    <img class="carousel-image" src="gambar/halaman_utama/2.jpeg" style="width: 100%; height: 50vw;">
                  </div>
                    <div class="item">
                    <img class="carousel-image" src="gambar/halaman_utama/3.jpeg" style="width: 100%; height: 50vw;">
                  </div>
               <?php } ?>
                </div>
