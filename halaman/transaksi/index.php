...
<head>
  ...
  <title>ikids | Pelayanan Servis iphone</title>
  ...
  <header class="main-header bg-blue">
    <nav class="navbar navbar-static-top">
      <div class="container">
        ...
        <div style="width: 400px;"><a href="index.php"><h3><p style="color: white">Welcome Staff ikids</p></h3>
      </ul>
      <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
        <ul class="nav navbar-nav">
  <button><li style="background-color: white"><li><a href="index.php?halaman=data_pelanggan">Data Pelanggan</li></button>
        </div>
      </ul>
       <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
        <ul class="nav navbar-nav">
  <button><li style="background-color: white"><li><a href="index.php?halaman=transaksi">Data Transaksi</li></button>
        </div>
      </ul>
       <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
        <ul class="nav navbar-nav">
  <button><li style="background-color: white"><li><a href="index.php?halaman=riwayat_booking">Data Booking COD</li></button>
        </div>
      </ul>
...
<script src="../../tampilan/bower_components/jquery/dist/jquery.min.js"></script>
  <div class="content-wrapper">
   ...
   else if (@$_GET['halaman']=='riwayat_booking') {
      include "riwayat_booking.php";
   }
   else if (@$_GET['halaman']=='edit_booking') {
      include "edit_booking.php";
   }
   else if (@$_GET['halaman']=='hapus_booking') {
      include "hapus_booking.php";
   }
   else {
  ...
  <footer class="main-footer">
    <div class="container">
      <div class="pull-right hidden-xs">
        <b>ikids_service</b> L200140103
      </div>
      <strong>Sistem Informasi Pelayanan ikids Servis iphone</a>.</strong>
    </div>
    <!-- /.container -->
  </footer>
</div>
